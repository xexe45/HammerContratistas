...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2018 a las 05:48:10
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_editar_mensaje` (IN `v_id` INT, OUT `v_res` BOOLEAN)  BEGIN
declare exit handler for sqlexception
begin
rollback;
set v_res = false;
...
(1, 'Juan Cosio Coma', '964088583', 'juanco@gmail.com', 'Hola comunicarse conmigo por favor, necesito un proyecto de una capilla', '2018-06-18 02:57:23', 1),
